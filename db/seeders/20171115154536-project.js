        ...
        return queryInterface.bulkInsert('projects', [
            {
                ...
                price: 200000,
                status: 'draft',
                thumbUrl: 'https://sj-foundation-old.softjourn.if.ua/wp-content/uploads/42-620x269.jpg',
            ...
            },
            {
                ...
                price: 200000,
                status: 'draft',
                thumbUrl: 'https://sj-foundation-old.softjourn.if.ua/wp-content/uploads/39-480x320.jpg',
                due: '2017-12-15 23:59:59',
                categoryId: 3,
                creatorId: 2,
                donateMore: true,
            ...
            },
            {
                ...
                price: 200000,
                status: 'draft',
                thumbUrl: 'https://sj-foundation-old.softjourn.if.ua/wp-content/uploads/fingerprints-FB-1-320x320.jpg',
                due: '2017-12-15 23:59:59',
                categoryId: 2,
                creatorId: 3,
                donateMore: true,
            ...
            },
            {
                ...
                price: 200000,
                status: 'draft',
                thumbUrl: 'https://sj-foundation-old.softjourn.if.ua/wp-content/uploads/pomegranate-table-620x310.png',
                due: '2017-12-15 23:59:59',
                categoryId: 4,
                creatorId: 4,
                donateMore: true,
            ...
            },
            {
                ...
                price: 200000,
                status: 'draft',
                thumbUrl: 'https://sj-foundation-old.softjourn.if.ua/wp-content/uploads/91pGyoxepxL._SL1500_-620x209.jpg',
                due: '2017-12-15 23:59:59',
                categoryId: 1,
                creatorId: 5,
                donateMore: true,
            ...
            },
            {
                ...
                price: 200000,
                status: 'draft',
                thumbUrl: 'https://sj-foundation-old.softjourn.if.ua/wp-content/uploads/481195-480x320.jpg',
                due: '2017-12-15 23:59:59',
                categoryId: 3,
                creatorId: 6,
                donateMore: true,
